<div id = "dealsbar-deals-toolbar" style = " 
  ...
  <div id = "dealsbar-toolbar-navi">
    <i id = "dealsbar-toolbar-left" title = "Previous Deal" class = "fa fa-chevron-circle-left"></i>
    <i id = "dealsbar-toolbar-right" title = "Next Deal" class = "fa fa-chevron-circle-right"></i>
    <i id = "dealsbar-toolbar-close" title = "Close Deals" class = "fa fa-times-circle"></i>
  </div>
</div>